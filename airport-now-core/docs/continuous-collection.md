...
- Runner IPv4 capture first; authenticated Worker acquisition is the fallback. Only a complete, recent, ordered capture can be imported. Provider secrets remain in GitHub; raw provider responses and secrets are not uploaded as artifacts.
