...
for(const file of htmlFiles){
 ...
 if(rel==='reference-prices/index.html'){
   if(!html.includes('"@type":"WebApplication"'))errors.push('reference-prices-schema-webapplication');
   if(!html.includes('"@type":"Dataset"'))errors.push('reference-prices-schema-dataset');
