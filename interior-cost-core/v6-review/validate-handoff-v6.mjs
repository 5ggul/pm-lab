...
for(const t of ['interior-v6-quote-check','interior-v6-compare','interior-v6-compare-handoff','current[`${i}:A`]','states.length===1','mixed.push','data-qc-to-compare','A/B/C 비교로 보내기','A 불러옴'])if(!handoff.includes(t))errors.push(`handoff:${t}`);
...
for(const t of ['quote-handoff-v6.js','data-quote-checker','#compare-rows','dataset.v6Handoff'])if(!search.includes(t))errors.push(`handoff-loader:${t}`);
