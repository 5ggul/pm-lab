...
if(!home.includes('v13-compat-marker'))home=home.replace('</body>','<!-- v13-compat-marker: 데이터 v13.0.0 -->\n</body>');
fs.writeFileSync(homePath,home);
console.log(JSON.stringify({legacy_report_version:report.version,v14_report:true,flags:Object.keys(v14).length,v13_compat_marker:true},null,2));
