...
- Pinned interior blobs were captured at `26b8f66b14316743e3bfaff73912a5b15901c48c` and verified unchanged through main `dc77c9c1b7acc1559ec0191a9d6c68c815b2f2a7` on 2026-09-18. Main movement after `16d00c5...` totals 19 commits touching car-data preview, franchise data/preview, updown/scan data, and related contract artifacts; the latest 4 commits changed only the franchise production contract JSON. Direct current-main blob recheck confirmed the four interior quote blobs still match 4/4.
