...
- Pinned interior blobs were captured at `26b8f66b14316743e3bfaff73912a5b15901c48c` and verified unchanged through main `340fe0683ccf49d4d3ab8a1eb0bcbb0597542db4` on 2026-09-18. Main movement after `16d00c5...` includes car-data preview, franchise data/preview, updown/scan data, and related contract artifacts; the latest `5dd0e9ed... → 340fe068...` 7 commits changed only the franchise production contract JSON. Direct current-main blob recheck confirmed the four interior quote blobs still match 4/4.
