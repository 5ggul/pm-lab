...
- Pinned interior blobs were captured at `26b8f66b14316743e3bfaff73912a5b15901c48c` and verified unchanged through main `5dd0e9ed407955d4a160e1bba397c85c473e43b9` on 2026-09-18. Main movement after `16d00c5...` totals 26 commits touching car-data preview, franchise data/preview, updown/scan data, and related contract artifacts; the latest 7 commits after `dc77c9c1...` changed only the franchise production contract JSON. Direct current-main blob recheck confirmed the four interior quote blobs still match 4/4.
