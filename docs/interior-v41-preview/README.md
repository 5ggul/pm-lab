...
- Hosted probes: `self-check.html` 58 checks, `failure-probe.html` 8 checks, `writer-concurrency-probe.html` 7 checks, `pending-recovery-probe.html` 9 checks, `stale-transfer-probe.html` 9 checks, `robustness-probe.html` 18 checks. Total: 109 hosted automatic checks. On 2026-09-18, external non-production HTTPS browser QA passed **109/109**, with the full runner at **110 assertions / 0 failures**.
