...
- Pinned interior blobs were captured at `26b8f66b14316743e3bfaff73912a5b15901c48c` and verified unchanged through main `1fcedb1e01a1a0372d35a3916a5c92646f901cfb` on 2026-09-17. Main movement after `918d62e9...` added 29 commits touching only `data/updown_positions.json`, `data/updown_trades.jsonl`, `data/updown_windows.jsonl`, and the franchise production contract JSON; the four interior quote blobs did not change.
...
- Hosted execution order is fixed in `HOSTED-QA-RUNBOOK.md`.
