...
pinned interior blob 캡처 기준: `26b8f66b14316743e3bfaff73912a5b15901c48c`

동일성 검증 완료 main: `200a129ad0eda851441749a01b25b82f33e43070` (2026-09-17)

`26b8f66..200a129` 사이에서 추가된 main 변경은 프랜차이즈/데이터 자동 갱신이었고 인테리어 quote-check/quote-compare HTML/CSS/JS blob은 변경되지 않았습니다.
...
- app-v21 bundle SHA: `4a82f3be0d598d9593f6eff21259f98e32ff231d`
- `app-v22` 없음
...
6. 운영 `interior-compare-v5/v6` 미사용
...
`production-shell/self-check.html`: **32개 항목**
...
외부 HTTPS preview가 아직 없으므로 `32/32 PASS`로 기록하지 않습니다.
