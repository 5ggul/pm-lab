...
function render(){
 ...
 else if(p[0]==='compare')html=comparePage(p[1],p[2],p[3]);
 ...
 else if(p[0]==='tools'&&p[1]==='candidate-finder')html=candidateFinderPage();
...
function bindPage(){
 bindSearch();bindBrandDirectory();bindCompareThree();bindCandidateFinder();bindRanking();bindAreas();bindStartup();bindBreakEven();bindDensity();bindFixedCost();
}
function bindSearch(){
