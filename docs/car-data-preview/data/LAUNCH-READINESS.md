...
- `/cars/` contains reviewed model links and licensed photos in its initial HTML. The fallback disappears only after the consumer catalog successfully renders. The normalized catalogue has 588 model families while all 4,203 source records remain preserved.
