...
for(const p of pairs){
  ...
  const html=`<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow,noarchive"><title>${p.title} | 내차데이터</title><meta name="description" content="${esc(p.note)}"><link rel="canonical" href="${siteConfig.baseUrl}compare/${p.slug}/"><link rel="stylesheet" href="../../assets/site.css"><link rel="stylesheet" href="../../assets/home.css"></head><body><header class="db-header"><div class="db-shell"><a class="db-logo" href="../../">내차데이터</a><nav class="db-nav" aria-label="주 메뉴"><a href="../../cars/">차량</a><a href="../">비교</a><a href="../../tools/annual-cost/">비용 계산</a><a href="../../recalls/">리콜</a><a href="../../data-sources/">출처</a></nav></div></header><main><section class="page-hero"><div class="pilot-wrap"><p><a href="../">차량 비교</a> / ${p.title}</p><h1>${p.title}</h1><p>${p.note}</p><a class="pilot-cta" data-pilot-calculate href="../?${esc(params)}">이 사양으로 세금·에너지비 계산</a><p class="pilot-note">연 20,000km로 시작하며 주행거리와 단가를 바꿀 수 있습니다. 전기차는 충전단가를 입력한 뒤 계산합니다.</p></div></section><section class="db-section"><div class="pilot-wrap pilot-grid">${variantCard(p.a,p.av)}${variantCard(p.b,p.bv)}</div></section><section class="pilot-trust"><div class="pilot-wrap"><h2>비교 전에 확인하세요</h2><details class="cost-basis"><summary>포함 항목과 계산식</summary><p>${scope}</p><p>${formula}</p></details><p>연비·전비는 위 사양 기준입니다.</p><div class="pilot-links"><a href="../../methodology/">계산 기준</a><a href="../../data-sources/">출처와 갱신 기준</a></div></div></section></main><footer class="db-footer"><div class="pilot-wrap">내차데이터 · 공식 자료와 입력 조건을 함께 확인하세요.</div></footer></body></html>`;
