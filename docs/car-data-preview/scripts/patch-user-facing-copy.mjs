...
const replacements=[
  ...
  ["${f.category?esc(f.category):'공식 신고 데이터'}","${f.category?' · '+esc(f.category):' · 공식 신고 데이터'}"],
  ['차종·세대 정규화','차종·세대 분류'],
  ...
  ['<option value="이전 제공 기록">이전 제공 기록</option>','<option value="removed_from_latest">이전 제공 기록</option>'],
