...
const home=fs.readFileSync(path.join(root,'index.html'),'utf8');assert.doesNotMatch(home,/<small>0[123]<\/small>/);assert.match(home,/아이오닉 6 · 공식 복합전비[\s\S]*?6\.3 km\/kWh/);assert.doesNotMatch(home,/hero-data-stream[\s\S]*?11\.7 km\/L/);
