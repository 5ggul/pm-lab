...
const head=(title,description,rel,prefix)=>`<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow,noarchive"><title>${esc(title)} | 내차데이터</title><meta name="description" content="${esc(description)}"><link rel="canonical" href="https://5ggul.github.io/pm-lab/car-data-preview/${rel}"><link rel="stylesheet" href="${prefix}assets/site.css"><link rel="stylesheet" href="${prefix}assets/home.css"><link rel="stylesheet" href="${prefix}assets/pilot.css"><script src="${prefix}assets/static-photo-fallback.js"></script></head>`;
