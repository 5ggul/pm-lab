...
fs.writeFileSync(path.join(root,'index.html'),home.replace('<div class="recall-list" id="homeRecalls">',`<p class="recall-coverage">${notices.length}건 표시 · 자동 갱신 ${recallData.data_as_of} · 전체 공지는 <a href="https://www.car.go.kr/ri/stat/list.do">자동차리콜센터</a></p><div class="recall-list" id="homeRecalls">`));
