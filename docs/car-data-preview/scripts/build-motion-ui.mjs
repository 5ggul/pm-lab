...
const homeSignal=`<!-- MOTION:HERO:START --><div class="hero-data-stream" aria-label="${featured.model} 대표 사양 수치"><span><svg class="hero-signal-icon" viewBox="0 0 32 32" aria-hidden="true"><path d="M6 22a10 10 0 0 1 20 0M16 22l6-7"/><circle cx="16" cy="22" r="1.5"/></svg><small>공식 표시연비</small><strong>${featured.rep.combined} km/L</strong></span><span><svg class="hero-signal-icon" viewBox="0 0 32 32" aria-hidden="true"><rect x="8" y="5" width="16" height="22" rx="2"/><path d="M12 11h8M12 16h8M12 21h4"/></svg><small>계산 자동차세</small><strong>${number(featured.rep.tax)}원</strong></span><span><svg class="hero-signal-icon" viewBox="0 0 32 32" aria-hidden="true"><path d="M17 3 9 17h7l-1 12 8-15h-7z"/></svg><small>계산 유류비 · 연 2만km</small><strong>${number(featured.rep.annualEnergy)}원</strong></span></div><!-- MOTION:HERO:END -->`;
let pages=0;
