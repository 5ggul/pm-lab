...
for(const folder of ['rankings','compare'])for(const entry of fs.readdirSync(path.join(root,folder),{withFileTypes:true})){
 ...
 if(folder==='rankings'){
  ...
  s=s.replace('<div class="rank-list">',wrap(`<p class="rank-chart-note">${note}<br>사진은 차종별 대표 이미지로, 표시된 연식·사양과 외관이 다를 수 있습니다. <a href="../../media-policy/#vehicle-photo-credits">사진 출처·이용 조건</a></p>` )+'<div class="rank-list">');
 }
 if(folder==='compare'){
