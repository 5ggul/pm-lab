...
const changeRows=calcIndex.rows.filter(row=>row.family_name==='Change');assert(changeRows.length&&changeRows.every(row=>!row.energy_cost_ready),'unit-conflicting Change rows must not calculate energy cost');
