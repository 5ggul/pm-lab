-- Canonicalize end-user inserts and prevent clients from selecting privileged states.
...
begin
  ...
  if tg_table_name = 'questions' then
    ...
    new.accepted_answer_id := null;
    v_action := 'question';
    v_limit := 5;
    v_text := new.title || ' ' || new.body;
...
revoke execute on function private.r1_guard_ugc_insert()
