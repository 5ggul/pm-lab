...
const VERIFIED_PREVIEW_CODES: GameCode[] = [
  {
    ...
    reviewed_by: null,
    review_note: "Roblox 공식 게임 설명에서 2026-09-25 직접 확인한 Preview 검증 코드",
    verified_at: checkedAt,
    last_checked_at: checkedAt,
    expires_at: null,
    notes: "Tower Defense Simulator Roblox 공식 설명에 'use code 2MILLION for 1000 coins!'로 안내됨.",
