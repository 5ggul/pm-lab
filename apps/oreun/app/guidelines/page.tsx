...
export default async function GuidelinesPage() {
  ...
  return (
    <InfoPage
      games={games}
      title="커뮤니티 가이드라인"
      intro="게임별 질문·답변·댓글에 적용하는 운영 기준입니다."
    >
      <div className="callout">
        오름 커뮤니티는 자유게시판이 아니라 Game Entity에 연결된 Q&A가
        기본입니다. 게시물은 신고와 운영 검토에 따라 숨김 처리될 수 있습니다.
      </div>
      ...
      <h2>자동 방어</h2>
      <p>
        질문·답변·댓글·신고에는 계정 상태 확인, 쓰기 횟수 제한과 일부
        개인정보·인증정보·외부 연락처 패턴 차단을 적용합니다. 자동 차단은
        완벽한 판별기가 아니므로 신고 기능과 운영 검토를 함께 사용합니다.
      </p>
