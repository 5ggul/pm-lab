    ...
    <>
      ...
      <main className="page methodology">
        ...
        <div className="callout">
          ...
          변화율과 급상승 지표는 로블잼이 시간대별로 저장한 관측값에서 계산합니다.
        </div>
        ...
        <h2>지역별 이용 제한</h2>
        <p>
          Roblox가 한국 리전에서 특정 게임을 이용 제한 상태로 반환하면 로블잼은 이를
          일반 API 장애와 구분해 표시합니다. 이 경우 해외 중계를 이용해 현재 접속자
          수를 우회 수집하지 않으며, 마지막 정상 관측값은 현재값이 아니라 과거 기록에만
          남깁니다.
        </p>
