...
(async()=>{
  ...
  must(routes.length===70,'index allowlist frozen at 70 routes',String(routes.length));
  ...
  must(sitemapLocs.includes(PREVIEW_CANON+'/region/'),'region hub included in sitemap');
