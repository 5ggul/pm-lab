...
const authorityBaseUiVersion='11.25';
...
const currentUiVersion=String(manifest.uiVersion||'');
...
const post={revision,generatedAt,baseUiVersion:authorityBaseUiVersion,currentUiVersion,productionCandidateCount:candidateCount,maxCandidateDepth:max,orphanCandidateCount:orphan.length,hubCoverageComplete:Object.values(hubCoverage).every(x=>x.missing.length===0),singleSnapshot:snapshot.uiVersion==='11.25'&&snapshot.brand_count===136,homeTerminalPreserved:html.get('/')?.includes('data-v25-home="1"')===true,toolsHubCoverage:approved.length-missingApprovedTools.length};
