...
const retentionWorkspaceUx=retentionWorkspace.retentionWorkspace===true&&retentionWorkspace.brandWorkspaces===136&&retentionWorkspace.updatesRadarRows===12&&retentionWorkspace.localOnlyPersistence===true&&retentionWorkspace.candidateNotes===true&&retentionWorkspace.checklistProgressSummary===true&&retentionWorkspace.candidatePlanning===true&&retentionWorkspace.shortlistDashboard===true&&retentionWorkspace.shortlistBackup===true&&retentionWorkspace.changeInbox===true&&retentionWorkspace.changeInboxSurfaces===2&&retentionWorkspace.changeAcknowledgement===true&&retentionWorkspace.changedOnlyFilter===true&&retentionWorkspace.shortlistDecisionBoard===true&&retentionWorkspace.shortlistCsvExport===true&&retentionWorkspace.editorialRails===3&&retentionWorkspace.editorialGuideLinks===9;
