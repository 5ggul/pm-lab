...
export function validateRetentionWorkspace(root){
 ...
 for(const token of ['data-v52-dashboard-saved','data-v52-dashboard-checks','data-v52-dashboard-changes','data-v52-export-shortlist','data-v52-import-shortlist','data-v52-import-file'])if(!home.includes(token))throw new Error(`Home shortlist control missing ${token}`);
 ...
 for(const token of ['franchiseLabShortlistV1','franchiseLabRecentV1','franchiseLabChecklistV1:','franchiseLabNoteV1:','franchiseLabPlanV1:','data-v52-load-saved','data-v52-ack-change','data-v52-candidate-note','data-v52-export-shortlist','data-v52-import-shortlist'])if(!js.includes(token))throw new Error(`Retention JS missing ${token}`);
 return{retentionWorkspace:true,brandWorkspaces,assetPages,homeWorkspace:true,compareSavedLoader:true,updatesRadarRows:12,localOnlyPersistence:true,candidateNotes:true,checklistProgressSummary:true,candidatePlanning:true,shortlistDashboard:true,shortlistBackup:true,editorialRails:3,editorialGuideLinks};
}
