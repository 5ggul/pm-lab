...
console.log(JSON.stringify({v11_52ReleaseCandidateValidation:'PASS',htmlPages:311,bodyCoverage,candidates:184,noindex,singleH1,metaDescriptions,canonicalPreview,brandDecisionPages,brandDecisionTagged,brandLowerFunnelEligiblePages,brandLowerFunnelUx:true,compareSelectedOptions:2,compareHydrationAligned:true,compareDecisionUx:true,staticCompareDecisionPages:7,staticCompareDecisionUx:true,legacyCompareDecisionPages:2,legacyCompareDecisionUx:true,toolsDecisionUx:true,homeDecisionUx:true,trustConsistencyUx:true,discoveryHubsUx:true,visualIntegrityUx:true,prelaunchQualityUx:true,rankingFaqItems:4,historyNotePages:report.historyNotePages,brandAnchorOffsets:true,releaseInputsOwnedByProductionGate:true,retentionWorkspaceUx:true,retentionBrandWorkspaces:136,updatesRadarRows:12,localOnlyPersistence:true,editorialRails:3,editorialGuideLinks:9,publisherValueUx:true,publisherValueItems:6,automationDisclosure:true,originalAnalysisDisclosure:true,contextualGuidesUx:true,contextualBrandRails:136,contextualCategoryRails:16,contextualHubRails:6,contextualTotalRails:158,contextualGuideLinks:474,contextualCandidateOnly:true,internalLinksChecked:report.totalInternalLinks,assetsChecked:report.totalInternalAssets,imagesChecked:report.imageCount,rcReady:true,productionDeployed:false},null,2));
