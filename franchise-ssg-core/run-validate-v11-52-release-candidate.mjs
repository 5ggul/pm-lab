...
if(report.prelaunchQualityUx!==true||Number(report.rankingFaqItems)!==4||Number(report.historyNotePages)<=0||report.brandAnchorOffsets!==true||report.previewReleaseBlocked!==true)err.push(`report prelaunchQuality ${report.prelaunchQualityUx}/${report.rankingFaqItems}/${report.historyNotePages}/${report.brandAnchorOffsets}/${report.previewReleaseBlocked}`);
