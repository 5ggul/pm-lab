...
try { const retention=validateRetentionWorkspace(out); if(retention.brandWorkspaces!==136||retention.updatesRadarRows!==12||retention.localOnlyPersistence!==true||retention.candidateNotes!==true||retention.checklistProgressSummary!==true||retention.candidatePlanning!==true||retention.shortlistDashboard!==true||retention.shortlistBackup!==true||retention.changeInbox!==true||retention.changeInboxSurfaces!==2||retention.changeAcknowledgement!==true||retention.changedOnlyFilter!==true||retention.editorialRails!==3||retention.editorialGuideLinks!==9)err.push(`retention workspace coverage ${retention.brandWorkspaces}/${retention.updatesRadarRows}/${retention.localOnlyPersistence}/${retention.candidateNotes}/${retention.checklistProgressSummary}/${retention.candidatePlanning}/${retention.shortlistDashboard}/${retention.shortlistBackup}/${retention.changeInbox}/${retention.changeInboxSurfaces}/${retention.changeAcknowledgement}/${retention.changedOnlyFilter}/${retention.editorialRails}/${retention.editorialGuideLinks}`); } catch(error) { err.push(`retention workspace: ${error.message}`); }
