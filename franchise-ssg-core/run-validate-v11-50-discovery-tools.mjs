...
if(manifest.uiVersion!=='11.50')err.push(`manifest ${manifest.uiVersion}`);
...
// v11.49 must remain intact after this completion pass.
...
if(err.length){console.error(JSON.stringify({v11_50DiscoveryToolsValidation:'FAIL',count:err.length,categoryRails,toolContexts,v49Brands,noindex,errors:err.slice(0,220)},null,2));process.exit(1)}
console.log(JSON.stringify({v11_50DiscoveryToolsValidation:'PASS',trustedFilterBrands:136,categoryRails,toolContexts,rankings:true,explore:true,v49Brands,noindex,candidates:184,v42VisualLanguagePreserved:true,productionDeployed:false},null,2));
